...
📂 Project Structure
leaf-disease-dcgan/ │ ├── src/ │ ├── generator.py # Generator model │ ├── discriminator.py # Discriminator model │ ├── train_dcgan.py # GAN training script │ ├── data_loader.py # Dataset loader │ ├── prepare_data.py # Data splitting │ ├── inference.py # Image generation script │ └── app_leaf_gan.py # Streamlit web app │ ├── configs/ │ └── data_config.yaml # Dataset configuration │ ├── checkpoints/ # Saved model weights ├── samples/ # Generated images per epoch ├── figures/ # Evaluation plots └── README.md
